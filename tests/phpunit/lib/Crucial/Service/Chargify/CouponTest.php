...
class Crucial_Service_Chargify_CouponTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testValidateSuccess()
    {
        ...
        // check for a couple of attributes on the $adjustment object
        $this->assertNotEmpty($coupon['id'], '$coupon["id"] was empty');
        $this->assertEquals($coupon['id'], '22311', '$coupon["id"] mismatch');
        $this->assertEquals($coupon['product_family_id'], '11309', '$coupon["product_family_id"] mismatch');
        $this->assertEquals($coupon['code'], 'TEST2', '$coupon["code"] mismatch');
    }
